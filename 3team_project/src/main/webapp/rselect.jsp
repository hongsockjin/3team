...
<%
	...
	List<LookDto> list = dao.getRmList();
	...
	<div class="machine">
		...
		<div class="m1">
			<table border="1">
				...
				<col width="10%">
				<tr>
					<th>브랜드</th><th>제품명</th><th>최소금액</th><th>최대금액</th><th>용량</th><th>에너지효율</th><th>할부금</th>
				</tr>
				<%
				...
				<tr id="abc">
					...
					<td><%=dto.getRname()%></td>
					<td><%=dto.getMinprice()%></td>
					<td><%=dto.getMaxprice()%></td>
					<td><%=dto.getRamount()%></td>
					<td><%=dto.getRenergy()%></td>
					<td><%=dto.getRyearprice()%></td>
					<td><button  class="bbb" value="[브랜드:<%=dto.getSeq()%> | 제품명:<%=dto.getRname()%> | 최소금액:<%=dto.getMinprice()%> | 최대금액:<%=dto.getMaxprice()%> | 용량:<%=dto.getRamount()%> | 에너지효율:<%=dto.getRyearprice()%> | 할부금:<%=dto.getTdisplay()%>]" onclick="Choose1(this.value)">선택</button></td>
				</tr>
				<%
				}
				%>
		...
		<div class="m2">
			<table border="1">
				...
				<tr>
					...
					<td><%=dto.getRenergy()%></td>
					<td><%=dto.getRyearprice()%></td>
					<td><button  class="bbb" value="[브랜드:<%=dto.getSeq()%> | 제품명:<%=dto.getRname()%> | 최소금액:<%=dto.getMinprice()%> | 최대금액:<%=dto.getMaxprice()%> | 용량:<%=dto.getRamount()%> | 에너지효율:<%=dto.getRyearprice()%> | 할부금:<%=dto.getTdisplay()%>]" onclick="Choose2(this.value)">선택</button></td>
				</tr>
				<%
				}
				%>
