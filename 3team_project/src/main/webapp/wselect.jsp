...
<%
	...
	List<LookDto> list = dao.getWmList();
	...
	<div class="machine">
		...
		<div class="m1">
			<table border="1">
				...
				<col width="10%">
				<tr>
					<th>브랜드</th><th>제품명</th><th>가격</th><th>용량</th><th>통/드럼</th><th>옵션수</th><th></th>
				</tr>
				...
				<tr id="abc">
					...
					<td><%=dto.getWname()%></td>
					<td><%=dto.getWprice()%></td>
					<td><%=dto.getWamount()%></td>
					<td><%=dto.getWtype()%></td>
					<td><%=dto.getWoption()%></td>
					<td><button  class="bbb" value="[브랜드:<%=dto.getSeq()%> | 제품명:<%=dto.getWname()%> | 가격:<%=dto.getWprice()%> | 용량:<%=dto.getWamount()%> | 통/드림:<%=dto.getWtype()%> | 옵션수:<%=dto.getWoption()%>]" onclick="Choose1(this.value)">선택</button></td>
				</tr>
				<%
				}
				%>
		...
		<div class="m2">
			<table border="1">
				...
				<tr>
					...
					<td><%=dto.getWtype()%></td>
					<td><%=dto.getWoption()%></td>
					<td><button  class="bbb" value="[브랜드:<%=dto.getSeq()%> | 제품명:<%=dto.getWname()%> | 가격:<%=dto.getWprice()%> | 용량:<%=dto.getWamount()%> | 통/드림:<%=dto.getWtype()%> | 옵션수:<%=dto.getWoption()%>]" onclick="Choose2(this.value)">선택</button></td>
				</tr>
				<%
				}
				%>
